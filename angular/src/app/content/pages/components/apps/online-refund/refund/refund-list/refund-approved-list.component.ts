...
export class RefundApprovedListComponent implements OnInit {
    // Table fields
    dataSource: RefundDataSource;
    displayedColumns = ['approvedDate', 'refundNumber', 'fullName', 'refundAmount', 'status', 'aging', 'remark', 'actions'];
    ...
    loadApprovedRefundList() {
        ...
        this.dataSource.loadApprovedRefund(queryParams);
    }
    ...
    getComponentTitle() {
        let result = 'Approved Refund List';
        return result;
    }
}
