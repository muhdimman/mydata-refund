...
export class RefundNewListComponent implements OnInit {
    // Table fields
    dataSource: RefundDataSource;
    displayedColumns = ['requestedDate','refundNumber', 'fullName', 'refundAmount', 'status', 'reason', 'aging', 'actions'];
